...
import { acceptFriendRequest, getFriendRequests, deleteFriendRequest } from "../lib/api"; // ✅ Added deleteFriendRequest
...
const NotificationsPage = () => {
  ...
  // ✅ NEW: Decline Friend Request Mutation
  ...
  useEffect(() => {
    const total = incomingRequests.length + acceptedRequests.length;
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="container mx-auto max-w-4xl space-y-8">
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight mb-6 flex items-center gap-2">
          Notifications
          {notificationCount > 0 && (
            <span className="badge badge-primary">{notificationCount}</span>
          )}
        </h1>
